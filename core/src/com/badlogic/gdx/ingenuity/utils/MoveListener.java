...
public class MoveListener extends DragListener {
	...
	// 仅当时桌面版该 Listener 才有效
	boolean openFunction = Gdx.app.getType() == ApplicationType.Desktop;
